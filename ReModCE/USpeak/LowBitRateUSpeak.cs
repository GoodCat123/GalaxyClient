...
namespace ReModCE.USpeak
{
    class LowBitRateUSpeak : ModComponent
    {
        ...
        public override void OnUiManagerInit(UiManager uiManager)
        {
            ...
            _LowBitRateUSpeakToggled = exploitMenu.AddToggle("Low BitRate", "Sets USpeaker bitrate to be 8kpb/s instead of the default 24kpbs/s, in other words, 2013 minecraft lets play mic", PerformLowBitRate, _LowBitRateUSpeakEnabled);
        }
