...
namespace ReModCE.Components
{
    internal class LoadingMusicComponent : ModComponent
    {
        ...
        private static void LoadingScreen()
        {
            ...
            textobj.GetComponent<Text>().m_Text = "Welcome to <color=#9f45b0>Space</color>";
            textobj.GetComponent<Text>().text = "Welcome to <color=#9f45b0>Space</color>";
            ...
            gameObject.AddComponent<Image>().sprite = ResourceManager.GetSprite("remodce.remod");
