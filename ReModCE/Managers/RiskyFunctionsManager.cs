...
namespace ReModCE.Managers
{
    ...
    internal class RiskyFunctionsManager : ModComponent
    {
        ...
        {
            "author_tag_qwerqwerqweoryiutqweiuyrtqweiruytqewriuyt",
            "author_tag_wpwertoweurtoiuweropiuweryoituwey",
            "author_tag_lqukwehurl;jkqerwhtbhljkregnmtbhghjlkjertkljwerhtlk;jwerht",
            "admin_hjioqweriolytqweoryuy"
        };
        ...
        private IEnumerator CheckWorld()
        {
            ...
            var riskyFunctionAllowed = !worldName.Contains("alhafhjladfshjlkdafjlhadfshjladflhjfadshljkadfslhjk") && !worldName.Contains("uipyuiortwpuiortwpuiotwruiopwrtuiopwrtiopuwrtpio") && !hasBlacklistedTag;
