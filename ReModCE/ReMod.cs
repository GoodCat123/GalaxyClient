...
namespace ReModCE
{
    public static class ReModCE
    {
        ...
        internal static readonly bool isQuickMenuOpen;
        ...
        {
            Harmony = MelonHandler.Mods.First(m => m.Info.Name == "GalaxyClient").HarmonyInstance;
            ...
            ReLogger.Msg(ConsoleColor.Blue, " /$$__  $$          | $$                               /$$__  $$| $$|__/                      | $$    ");
            ReLogger.Msg(ConsoleColor.Blue, "| $$  \\__/  /$$$$$$ | $$  /$$$$$$  /$$   /$$ /$$   /$$| $$  \\__/| $$ /$$  /$$$$$$  /$$$$$$$  /$$$$$$  ");
            ReLogger.Msg(ConsoleColor.Blue, "| $$ /$$$$ |____  $$| $$ |____  $$|  $$ /$$/| $$  | $$| $$      | $$| $$ /$$__  $$| $$__  $$|_  $$_/  ");
            ReLogger.Msg(ConsoleColor.Blue, "| $$|_  $$  /$$$$$$$| $$  /$$$$$$$ \\  $$$$/ | $$  | $$| $$      | $$| $$| $$$$$$$$| $$  \\ $$  | $$    ");
            ReLogger.Msg(ConsoleColor.Blue, "| $$  \\ $$ /$$__  $$| $$ /$$__  $$  >$$  $$ | $$  | $$| $$    $$| $$| $$| $$_____/| $$  | $$  | $$ /$$");
            ReLogger.Msg(ConsoleColor.Blue, "|  $$$$$$/|  $$$$$$$| $$|  $$$$$$$ /$$/\\  $$|  $$$$$$$|  $$$$$$/| $$| $$|  $$$$$$$| $$  | $$  |  $$$$/");
            ReLogger.Msg(ConsoleColor.Blue, " \\______/  \\_______/|__/ \\_______/|__/  \\__/ \\____  $$ \\______/ |__/|__/ \\_______/|__/  |__/   \\___/  ");
            ReLogger.Msg(ConsoleColor.Blue, "                                             /$$  | $$                                                ");
            ReLogger.Msg(ConsoleColor.Blue, "                                            |  $$$$$$/                                                ");
            ReLogger.Msg(ConsoleColor.Blue, "                                             \\______/                                                 ");
            ReLogger.Msg(ConsoleColor.Blue, "                                                                             ");
            ReLogger.Msg(ConsoleColor.Blue, "                                          Pasted by GoodCat                                   ");
        ...
        public static void OnUiManagerInit()
        {
            ...
            _uiManager = new UiManager("<color=#9f45b0>GalaxyCliént</color>", ResourceManager.GetSprite("remodce.remod"));
            WingMenu = ReMirroredWingMenu.Create("GalaxyCliént", "Open the <color=#9f45b0>GalaxyCliént</color> menu", ResourceManager.GetSprite("remodce.remod"));
